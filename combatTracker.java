...
public class combatTracker {
    ...
    public static void main(String[] args) {
        ...
        try {
	        ...
	        // System.out.println("Level of Party: " + level + "\nSize of Encounter: " +size + " monsters");
	        ...
	        for (int i=0; i<numberOfMonsters; i++){ 
	        	int x = (randomGenerator.nextInt(8)) - 4;
	        	monster M= new monster((i), level, x);
	        	M.display();
	        	allMonsters.add(M);
	        	monst[i] = M;
	        	}
		        ...
		        if (numberDead == numberOfMonsters){ 
		        	...
		        	System.out.println("\n: Enemy Attack Phase :");
		        		for (int k = 0; k < numberOfMonsters; k++){ 
		        				int atk = allMonsters.get(k).attack(randomGenerator.nextInt(4), randomGenerator.nextInt(6));
